...
def sort_points(points, regression_lines, sorted_point_distance=0.5):
...
# Thin & sort points
thinned_points, regression_lines = thin_line(points,15)

# Test=np.concatenate(([Pstart], thinned_points[0:], [Pend]))


sorted_points = sort_points(thinned_points, regression_lines,30)
