...
def TripleLineLength(triple_line_points,EdgeLength):
    ...
    triple_line_points_l=UnWrapCluster(xyz_to_pcd(triple_line_points), EdgeLength)
    thinned_points, regression_lines=thin_line(triple_line_points_l, point_cloud_thickness=7)
    # 4
    P_start=TripleLineStartOrEnd(thinned_points)
    ...
    return(triple_line_length,interpolated_triple_line_path)
...
def TripleLineLength_For_all(TripleLine,EdgeLength):
    ...
    for i in range(0,len(TripleLine)):
        ...
        triple_line_length_i,interpolated_triple_line_path_i=TripleLineLength(triple_line_points_i,EdgeLength)
         
        TripleLineLength_for_all.append([triple_line_ID_i,triple_line_length_i,interpolated_triple_line_path_i])    
